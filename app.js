...
Gemini said
I see exactly what happened. When you updated the code, some of the old lines got mixed in with the new ones, creating "syntax errors" (broken code structure). Specifically, the SYSTEM_PROMPT is accidentally defined twice, and there are some missing helper functions that were in the original file but got lost in the copy-paste.

Since you are transitioning into a Senior ICT Service Agent role, you'll appreciate this "Clean Build" approach. Let’s replace your entire app.js with this corrected version.

The "Clean Build" app.js
Copy this entire block and replace everything currently in your app.js file on GitHub:
